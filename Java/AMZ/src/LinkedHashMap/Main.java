...
public class Main {
    ...
    public void returnBook(String studentName) {
        ...
        if (borrowedBooks.containsKey(studentName)) {
            ...
            System.out.println(studentName + " returned their books.");
        } else {
            System.out.println("The student " + studentName + " has not borrowed any book");
        }
    ...
    public void checkBorrowedBook(String studentName) {
        ...
        if (borrowedBooks.containsKey(studentName)) {
            System.out.println("Book title: " + borrowedBooks.get(studentName));
        }
    }
